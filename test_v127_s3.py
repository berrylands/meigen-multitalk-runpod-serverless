#!/usr/bin/env python3
"""
Test V127 with S3 Files
Test MultiTalk V127 with xfuser support using S3 files (1.wav and multi1.png)
"""
...
def test_s3_video_generation():
    ...
    print("🔍 Testing V127 with S3 files...")
                        ...
                        if status == "COMPLETED":
                            ...
                            if "output" in output:
                                ...
                                if "video_base64" in final_output:
                                    ...
                                    output_path = f"v127_s3_output_{int(time.time())}.mp4"
...
def main():
    print("=" * 80)
    print("V127 S3 VIDEO GENERATION TEST")
    print("=" * 80)
    print("Testing MultiTalk V127 with xfuser support")
    ...
    if success:
        print("✅ SUCCESS: V127 generated video from S3 files")
        ...
        print("❌ FAILED: V127 could not generate video")
        print("🔧 Troubleshooting:")
        print("1. Check if endpoint is running V127")

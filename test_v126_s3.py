#!/usr/bin/env python3
"""
Test V126 with S3 Files
Test MultiTalk V126 using the S3 files (1.wav and multi1.png)
"""
...
def test_s3_video_generation():
    ...
    print("🔍 Testing V126 with S3 files...")
                        ...
                        if status == "COMPLETED":
                            ...
                            if "output" in output:
                                ...
                                if "video_base64" in final_output:
                                    ...
                                    output_path = f"v126_s3_output_{int(time.time())}.mp4"
...
def main():
    print("=" * 80)
    print("V126 S3 VIDEO GENERATION TEST")
    print("=" * 80)
    print("Testing MultiTalk V126 with newer dependencies")
    ...
    if success:
        print("✅ SUCCESS: V126 generated video from S3 files")
        print("🎬 Check the output video file")
        print("\n🚀 Next Steps:")
        print("1. Verify video quality")
        print("2. Test with different parameters")
        print("3. Deploy to production")
        
    else:
        print("❌ FAILED: V126 could not generate video")
        print("🔧 Troubleshooting:")
        print("1. Check if endpoint is running V126")
        print("2. Verify S3 files exist and are accessible")
        print("3. Check RunPod logs for detailed errors")
        print("4. Ensure models are loaded correctly")

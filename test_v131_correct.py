#!/usr/bin/env python3
"""Test V131 with correct input format"""
import json
import time
import runpod
...
def test_v131():
    """Test V131 with fixed NumPy compatibility and correct input format"""
    ...
    # Test payload using V76 format that the handler expects
    test_input = {
        "input": {
            "audio_s3_key": "1.wav",           # Just filename
            "image_s3_key": "multi1.png",      # Just filename
            "turbo": True,                     # Not turbo_mode
            "sampling_steps": 40,
            "output_format": "s3"
        }
    }
    ...
    print(f"📊 Steps: {test_input['input']['sampling_steps']}")
...
if __name__ == "__main__":
    ...
    print("📝 Using V76 input format (audio_s3_key, image_s3_key)")
    print()

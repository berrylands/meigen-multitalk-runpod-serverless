#!/usr/bin/env python3
"""Test V130 again to see if NumPy issue persists"""
import subprocess
import json
import os
import time
...
print("🚀 Testing V130 (reverted from failed V131)...")
        ...
        if status_result.returncode == 0:
            ...
            if status == "COMPLETED":
                ...
                if "numba" in error_str and "numpy" in error_str:
                    print("\n⚠️  NumPy/Numba issue confirmed in V130")
                    print("Need to fix the build process")
                break
else:

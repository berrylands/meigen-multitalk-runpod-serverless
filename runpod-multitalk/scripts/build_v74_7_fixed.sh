...
# Build script for MultiTalk V74.7 - Fixed kokoro dependency
set -e

echo "=============================================="
echo "Building MultiTalk V74.7 - Fixed Kokoro Support"
echo "=============================================="
...
IMAGE_TAG="berrylands/multitalk-v74-7:fixed-kokoro"
echo "Building Docker image: $IMAGE_TAG"

docker build \
    --file Dockerfile.v74-7-fixed \
    --tag "$IMAGE_TAG" \
...
if [[ $? -eq 0 ]]; then
    ...
    echo "  - Functional kokoro TTS implementation"
    echo "  - No external package dependencies"

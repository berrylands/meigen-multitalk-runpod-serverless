...
# Build script for MultiTalk V74.7 - Add kokoro TTS dependency
set -e

echo "=============================================="
echo "Building MultiTalk V74.7 - Kokoro TTS Support"
echo "=============================================="
...
IMAGE_TAG="berrylands/multitalk-v74-7:kokoro-tts"
echo "Building Docker image: $IMAGE_TAG"

docker build \
    --file Dockerfile.v74-7-kokoro \
    --tag "$IMAGE_TAG" \
...
if [[ $? -eq 0 ]]; then
    ...
    echo "  - kokoro TTS package installed"

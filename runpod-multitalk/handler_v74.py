...
Version: 74.0.0 - Actually install gcc to fix runtime compilation
...
# Version info
logger.info("=" * 80)
logger.info("MeiGen MultiTalk Handler V74.0.0 Starting")
logger.info("GCC Installation Fix - Runtime Compilation Support")
logger.info("=" * 80)

# Import after logging setup
try:
    logger.info("Importing MultiTalk V74 implementation...")
    from multitalk_v74_official_wrapper import MultiTalkV74OfficialWrapper
...
def handler(event: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info("Initializing MultiTalk V74...")
        ...
        # Generate video
        logger.info("Generating video with MultiTalk V74...")

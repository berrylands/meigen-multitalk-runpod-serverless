#!/usr/bin/env python3
"""
Test V125 with S3 Files
Test MultiTalk V125 using the S3 files (1.wav and multi1.png)
"""
...
def test_s3_video_generation():
    ...
    print("🔍 Testing V125 with S3 files...")
                        ...
                        if status == "COMPLETED":
                            ...
                            if "output" in output:
                                ...
                                if "video_base64" in final_output:
                                    ...
                                    output_path = f"v125_s3_output_{int(time.time())}.mp4"
...
def main():
    print("=" * 80)
    print("V125 S3 VIDEO GENERATION TEST")
    print("=" * 80)
    print("Testing MultiTalk V125 with S3 files")
    ...
    if success:
        print("✅ SUCCESS: V125 generated video from S3 files")
        ...
        print("❌ FAILED: V125 could not generate video")
        print("🔧 Troubleshooting:")
        print("1. Check if endpoint is running V125")
